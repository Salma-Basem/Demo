...
export class BoardmembersComponent {
  ...
  showMoreMember5 = false;
  showMoreMember6 = false;
  ...
  toggleMember4Visibility(): void {
    this.showMoreMember4 = !this.showMoreMember4;
  }

  toggleMember5Visibility(): void {
    this.showMoreMember5 = !this.showMoreMember5;
  }

  toggleMember6Visibility(): void {
    this.showMoreMember6 = !this.showMoreMember6;
  }
}
